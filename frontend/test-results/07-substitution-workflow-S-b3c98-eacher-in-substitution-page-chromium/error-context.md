...
- Name: 07-substitution-workflow.spec.js >> Substitution Workflow >> 03 - Should show absent teacher in substitution page
- Location: e2e/07-substitution-workflow.spec.js:75:3
...
Call log:
  - waiting for locator('.teacher-card').first().locator('h3')
